...
var Wallet = /** @class */ (function () {
    ...
    Wallet.prototype.generateRandomnString = function (length) {
        var result = "";
    ...
    Wallet.prototype.generatePortalId = function () {
        return "skywallet-".concat(this.generateRandomnString(10));
    };
    Wallet.prototype.getFrame = function () { };
    Wallet.prototype.injectPortal = function () {
        var _this = this;
        console.log("Injecting portal", this.portalId);
        var elem = document.getElementById(this.portalId);
        if (elem)
            return;
        // Start injecting iframe
        var style = document.createElement("style");
        style.innerHTML = "\n            #".concat(this.portalId, " .close-container {\n                min-width: 315px;\n                max-width: 428px;\n                width: 100%;\n                position: fixed;\n                left: 50%;\n                right: 50%;\n                transform: translateX(-50%);\n                -webkit-box-align: center;\n                align-items: center;\n                -webkit-box-pack: end;\n                justify-content: flex-end;\n                background-color: rgb(204, 213, 236);\n                z-index: 100;\n                height: 40px;\n                font-size: 14px;\n                font-weight: 700;\n                color: rgb(46, 54, 72);\n                cursor: pointer;\n                display: flex !important;\n            }\n            #").concat(this.portalId, " .close-icon {\n                width: 20px;\n                height: 20px;\n                padding: 0px;\n                margin: 10px;\n                pointer-events: all;\n                color: black;\n                font-size: 12px;\n                font-weight: 600;\n                z-index: 9;\n                background-color: rgb(253, 215, 63);\n                border: 0px;\n                cursor: pointer;\n                border-radius: 100% !important;\n            }\n            #").concat(this.portalId, " .iframe {\n                height: 926px;\n                max-width: 428px;\n                min-width: 375px;\n                width: 100%;\n                position: fixed;\n                left: 50%;\n                right: 50%;\n                -webkit-transform: translateX(-50%);\n                -moz-transform: translateX(-50%);\n                -ms-transform: translateX(-50%);\n                transform: translateX(-50%);\n                z-index: 99;\n                background-color: #e6eaf0;\n                padding-top: 2.5rem;\n                max-height: 90vh;        \n            }\n            @media (max-width: 429px) {\n                #").concat(this.portalId, " .iframe {\n                    height: 100%;\n                    max-height: 100vh;  \n                }\n            }\n            #").concat(this.portalId, " .overlay {\n                position: fixed;\n                display: block;\n                width: 100%;\n                height: 100%;\n                top: 0;\n                left: 0;\n                right: 0;\n                bottom: 0;\n                background-color: rgba(0, 0, 0, 0.5);\n                z-index: 90;\n                cursor: pointer;\n                -webkit-backdrop-filter: blur(20px);\n                backdrop-filter: blur(20px);\n            }\n            #").concat(this.portalId, " {\n                display: none;\n                position: fixed;\n                left: 0;\n                right: 0;\n                top: 0;\n                bottom: 0;\n                z-index: 88;        \n            }\n        ");
        ...
        iframe.setAttribute("allow", Object.keys(this.walletPermissions)
    ...
    Wallet.prototype.openWallet = function () {
        var _a;
        (_a = document
            .getElementById(this.portalId)) === null || _a === void 0 ? void 0 : _a.setAttribute("style", "display: block;");
    };
    Wallet.prototype.openBenefit = function (benefitId) { };
    Wallet.prototype.openNftDetail = function () { };
    Wallet.prototype.openMyNfts = function () { };
    Wallet.prototype.openCollections = function () { };
    Wallet.prototype.close = function () {
        var _a;
        (_a = document.getElementById(this.portalId)) === null || _a === void 0 ? void 0 : _a.setAttribute("style", "");
    };
    Wallet.prototype.on = function (eventName, handler) { };
    return Wallet;
}());
function initWallet() {
